...
export default function LoginPage() {
    ...
    useEffect(() => {
        if (step === 2 && totpInputRef.current) {
                    ...
                    <div className="w-full max-w-[420px]">
                        <div className="mb-16 text-center">
                            ...
                            <p className="text-base text-on-surface-variant">
                                {step === 1 ? 'Access your projects and sandboxes' : 'Enter your 2-step verification code'}
                            </p>
                        </div>
                        ...
                        <form className="space-y-6" onSubmit={handleLogin}>
                            ...
                            {step === 1 ? (
                                <>
                                    ...
                                    <div className="flex items-center gap-2 px-1 animate-in fade-in delay-150">
                                        <input type="checkbox" id="remember" className="rounded border-outline-variant/50 bg-surface-container-low text-primary-container focus:ring-primary-container" />
                                        <label htmlFor="remember" className="text-sm font-semibold text-on-surface-variant cursor-pointer">Remember me for 30 days</label>
                                    </div>
                                </>
                            ) : (
                                <div className="space-y-2 animate-in slide-in-from-right-4 fade-in">
                                    <label className="text-xs font-bold text-on-surface-variant px-1 uppercase tracking-widest" htmlFor="totpCode">Authentication Code</label>
                                    <div className="relative group">
                                        <input 
                                            ref={totpInputRef}
                                            className="w-full bg-surface-container-low border border-outline-variant/50 rounded-lg px-6 py-4 text-center tracking-[0.5em] text-2xl font-mono text-on-surface focus:border-primary-container focus:ring-1 focus:ring-primary-container transition-all outline-none" 
                                            id="totpCode" 
                                            name="totpCode" 
                                            value={totpCode}
                            ...
                            {step === 2 && (
                                <div className="text-center mt-4">
                                    <button 
                                        ...
                                        className="text-sm font-semibold text-primary-fixed-dim hover:underline"
                                    >
                                        Cancel and go back
                                    </button>
                                </div>
                        ...
                        {step === 1 && (
                            <>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <a href="http://localhost:8081/api/auth/google/login" className="flex items-center justify-center gap-2 bg-surface-container-low border border-outline-variant/50 py-4 rounded-lg hover:bg-surface-container-high transition-colors active:scale-95 duration-200">
                                    ...
                                    <a href="http://localhost:8081/api/auth/github/login" className="flex items-center justify-center gap-2 bg-surface-container-low border border-outline-variant/50 py-4 rounded-lg hover:bg-surface-container-high transition-colors active:scale-95 duration-200">
