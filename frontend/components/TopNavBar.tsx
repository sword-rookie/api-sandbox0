        ...
        <>
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 border-l border-outline-variant pl-4 ml-2">
                        ...
                        <button 
                            ...
                            className="material-symbols-outlined text-on-surface-variant hover:text-error transition-colors active:scale-95 ml-2"
                            title="Logout"
                        >
                            logout
                        </button>
            ...
            {isLogoutOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm">
                    <div className="bg-surface-container border border-outline-variant rounded-xl p-6 w-[400px] max-w-[90vw] shadow-[0_0_40px_rgba(0,0,0,0.5)] animate-in fade-in zoom-in duration-200">
                        <div className="flex items-center gap-3 mb-4 text-error">
                            <span className="material-symbols-outlined text-3xl">logout</span>
                            <h2 className="text-xl font-bold text-on-surface">Confirm Logout</h2>
                        </div>
                        ...
                        <div className="flex justify-end gap-3">
                            <button 
                                ...
                                className="px-4 py-2 text-sm font-semibold text-on-surface-variant hover:text-on-surface hover:bg-surface-container-lowest rounded-md transition-colors"
                            >
                                Cancel
                            </button>
                            <button 
                                onClick={handleLogout}
                                className="px-4 py-2 text-sm font-bold bg-error text-on-error rounded-md hover:brightness-110 active:scale-95 transition-all shadow-[0_0_10px_rgba(255,84,73,0.3)]"
                            >
                                Logout
                            </button>
                        </div>
